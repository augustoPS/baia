...
public enum Help {
    public static var text: String {
        ...
        lines.append("  explain [PANE] [--json]               why list says what it says: the process")
        lines.append("                                        tree, the last report, which authority")
        lines.append("                                        decided the attention word, and why")
        lines.append("")
