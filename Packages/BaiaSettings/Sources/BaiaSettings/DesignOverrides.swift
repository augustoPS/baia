...
public extension DesignOverrides {
    ...
    struct Chrome: Sendable, Equatable {
        ...
        /// A floor under the sidebar's wash opacity.
        ///
        /// The sidebar's glass is washed with the theme and follows
        /// ``Settings/backgroundOpacity``, so the band dims with the wells
        /// instead of staying put while the opacity knob moves them. At the low
        /// end of that range the wash approaches nothing and the sidebar stops
        /// reading as a surface. This is the minimum it may thin to; nil leaves
